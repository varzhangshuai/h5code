...
function renderPageList(data){
    if(data.length>0){
        ...
        for(var i=0;i<data.length;i++){
            lis+='<li class="page" id='+data[i].articleidStr+'><img class="page-img" src='+data[i].imageUrl+' alt=""><div class="page-r"><div class="page-title"><p class="els3">'+data[i].title+'</p></div><div class="page-time">'+data[i].utime+'</div></div> </li>'
        }
        $('#page-list').html(lis)
    }
